...
<% pageProcessor.createSyncPoint("buerger-skb1"); %>
<% ((java.util.Set)session.getAttribute("composer.visitedPages")).add("buerger-skb1"); %>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:cit="http://www.cit.de/ns/jsp" xmlns:html="http://www.w3.org/1999/xhtml" lang="de-DE" class="no-js">
  ...
  <!--plugin:ui-rbs2-->
      ...
      <title id="page-title">
         <cit:conditional test="!assistants.request.valid">Fehler beim Ausfüllen - </cit:conditional>buerger_eid_skb1 - Bürger SKB1</title>
      ...
      <cit:control>
         ...
         <cit:flow>
            <cit:if action="gosub" href="rbs_bez.jsp" test="rbsrule() == true"/>
         </cit:flow>
         <cit:page-validation id="d0e691" test="_test_d0e691()"/>
         <cit:page-validation id="d0e697" mode="loose" test="_test_d0e697()"/>
      </cit:control>
   </head>
   <body id="buerger-skb1">
      <div id="custom_top"/>
      <div id="if">
         <div id="page" class=" has_roadmap_right">
            ...
            <nav id="roadmap" class="roadmap roadmap_right">
               ...
               <ul class="icons"><% final boolean unvisited_d4e2 = !isVisited(session, "buerger-skb1"); %><li class='present<%= unvisited_d4e2 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  </li><% final boolean unvisited_d4e4 = !isVisited(session, "rbs_bez"); %><li class='future<%= unvisited_d4e4 ? " unvisited" : "" %>'>
                     <span class="item">
                        <span class="label">
                  ...
                  <section id="content" class=" narrow">
                     <cit:form beanName="myForm">
                        <div class="wizard-body">
                           ...
                           <cit:validationMessage for="d0e691">
                              <p class="invalidInfo v2">
                                 <span aria-hidden="true" class="icon-warning-sign"/>
                                 <strong>Die von Ihnen angegebene Adresse ist in unserem System nicht hinterlegt und kann nicht gefunden werden.</strong>
                              </p>
                           </cit:validationMessage>
                           <cit:validationMessage for="d0e697">
                              <p class="invalidInfo v2 loose">
                                 <span aria-hidden="true" class="icon-exclamation-sign"/>
                                 <strong>Die von Ihnen angegebene Adresse ist in unserem System nicht hinterlegt und kann nicht gefunden werden.<br/>Im nächsten Schritt können Sie Angaben zum Bezirk und Ortsteil machen um Ihren Antrag zu vervollständigen.</strong>
                              </p>
                           </cit:validationMessage>
                           ...
                           <section class="group narrow">
                              ...
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "anredeh") %>'>
                              ...
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000043_h") %>'>
                              ...
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000013_h") %>'>
                                 ...
                                 <div class="formline">
                                    ...
                                    <div class="inputcontainer">
                                       <cit:inputText name="F00000013_h" ariaLabelledby="$label-id $error-ids" required="true" onDefault="iseID() ? geteIDFamilyNames() : isSKB() ? getSKBLastname() : &#34;&#34;"/>
                                    </div>
                                 </div>
                              </section>
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000045_h") %>'>
                                 ...
                                 <div class="formline">
                                    ...
                                    <div class="inputcontainer">
                                       <cit:inputText name="F00000045_h" ariaLabelledby="$label-id $error-ids" required="true" onDefault="iseID() ? geteIDGivenNames() : isSKB() ? getSKBFirstname() : &#34;&#34;"/>
                                    </div>
                                 </div>
                              </section>
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000066_h") %>'>
                              ...
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000014_h") %>'>
                           ...
                           <section class="group narrow">
                              ...
                              <section class="block narrow label_before" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000069h") %>'>
                              ...
                              <section class="block narrow label_before" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000071h") %>'>
                           ...
                           <section class="group narrow rbs">
                              ...
                              <section class="block narrow 2_hide" data-comments='<%= getComments(pageContext.getAttribute("form"), "urlrbsdata") %>'>
                              ...
                              <section class="block narrow 2_hide" data-comments='<%= getComments(pageContext.getAttribute("form"), "urlrbsstrliste") %>'>
                              ...
                              <section class="block live narrow 2_hide" data-comments='<%= getComments(pageContext.getAttribute("form"), "objtype") %>' data-live-stay="stay_nonval_d0e271">
                                 ...
                                 <cit:inputSubmit type="stay.nonval.d0e271" id="stay.nonval.d0e271" value="OK" title="Klicken Sie auf OK, um die Seite zu aktualisieren."/>
                                 <script type="text/javascript">document.getElementById('stay_nonval_d0e271').style.display='none';</script>
                                 <cit:script>_unmask(myForm, "objtype", "string");</cit:script>
                              </section>
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000053h") %>'>
                              ...
                              <section class="block narrow label_before width-xs 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "hnrh") %>'>
                              ...
                              <section class="block narrow label_before width-xs 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "bisf00000016") %>'>
                              ...
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "adrzs") %>'>
                              ...
                              <section class="block narrow label_before width-xs 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000054h") %>'>
                              ...
                              <section class="block narrow 2_hide" data-comments='<%= getComments(pageContext.getAttribute("form"), "otnrh") %>'>
                              ...
                              <section class="block narrow label_before 2_hide_eid" data-comments='<%= getComments(pageContext.getAttribute("form"), "F00000035h") %>'>
                                 ...
                                 <div class="formline">
                                    ...
                                    <div class="inputcontainer">
                                       <cit:inputText name="F00000035h" ariaLabelledby="$label-id $error-ids" required="true" onDefault="setCityeIDSKB()"/>
                                    </div>
                                 </div>
                              </section>
                              ...
                              <section class="block narrow 2_hide" data-comments='<%= getComments(pageContext.getAttribute("form"), "etrs89_xh") %>'>
                              ...
                              <section class="block narrow 2_hide" data-comments='<%= getComments(pageContext.getAttribute("form"), "etrs89_yh") %>'>
                        ...
                        <nav id="roadmap_bottom" class="roadmap">
                           <h3 class="accessibility">Dialogverlauf</h3>
                           <ul class="icons"><% final boolean unvisited_d8e2 = !isVisited(session, "buerger-skb1"); %><li class='present<%= unvisited_d8e2 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Bürger SKB1</span>
                              ...
                              </li><% final boolean unvisited_d8e4 = !isVisited(session, "rbs_bez"); %><li class='future<%= unvisited_d8e4 ? " unvisited" : "" %>'>
                                 <span class="item">
                                    <span class="label">
                                       <span class="labeltext">Angaben zum Bezirk und Ortsteil</span>
